...
class CreatePlaylistPage(ctk.CTkFrame):
    ...
    def create_input(self, placeholder: str) -> ctk.CTkEntry:
    ...
    def save_location(self) -> None:
        ...
        try:
            ...
            success = self.db.add_location(
                lat, lng, continent, country, is_capital, user["id"]
            )
            ...
            if success:
                ...
                # Clear fields for the next contribution
                for entry in [
                    self.lat_entry,
                    self.lng_entry,
                    self.cont_entry,
